...
class SportRecordWeekSerializer(serializers.ModelSerializer):
    class Meta:
        model = SportRecordWeek
        fields = '__all__'
...
class DietRecordDateSerializer(serializers.ModelSerializer):
    class Meta:
        model = DietRecordDate
        fields = '__all__'